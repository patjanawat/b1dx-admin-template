...
export function FilterProductsSection() {
  ...
  const handleProcess = handleSubmit((values) => {
    const selectedCount = Object.values(values.table.rowSelection).filter(
      Boolean,
    ).length;
        ...
        >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <SimpleDecimalField
                      ...
                      placeholder="1"
                      errorMode="tooltip"
                      inputClassName="w-20 h-9 bg-muted/20 border-border/50"
                      scale={2}
                    />
          ...
          {selectedWarehouse === "2" && (
            <>
              {/* Product table */}
              <FilterProductSKU
                control={control} // TODO: refactor FilterProductSKU to accept control and other props, and move columns definition inside it
                // columns={columns}
                filteredProducts={filteredProducts}
                searchInput={searchInput}
                onSearchInputChange={setSearchInput}
            ...
            <>
              {/* Product table */}
              <FilterProductNumberItem
                control={control} // TODO: refactor FilterProductGroup to accept control and other props, and move columns definition inside it
                // columns={columns}
                filteredProducts={filteredProducts}
                searchInput={searchInput}
                onSearchInputChange={setSearchInput}
